...
function ProfileAvatar({ profile }) {
  ...
  return <span className="inline-flex h-9 w-9 cursor-pointer items-center justify-center overflow-hidden rounded-full border border-[#d6d6d6] bg-[#eeeeee] text-sm font-bold text-[#666666]">{initial}</span>;
}
