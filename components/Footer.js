      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-3">
        <div>
          <div className="mb-3 flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-[#3d2a14]">
              Paw <span className="text-[#e39b2e]">Sitter</span>
            </span>
          </div>
          <p className="max-w-xs text-sm leading-relaxed text-black">
            Warm, reliable pet sitting for dogs and cats. Walks, feeding, and peace of mind while you are away.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-black">
            Email:{" "}
            <a href="mailto:hello@pawsitter.example" className="font-medium text-black hover:underline">hello@pawsitter.example</a>
          </p>
        </div>
      </div>
      <div className="border-t border-[#efd09a] py-4 text-center text-xs text-black">
